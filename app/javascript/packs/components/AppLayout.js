          ...
          <main className={classes.content}>
            ...
            {currentSession && (
              <ActivitiesDialog
                ...
                onClose={() => this.setState({ activitiesDialog: false })}
              />
            )}
...
export default withStyles(styles)(
  withRouter(withCurrentSession(withWidth()(AppLayout)))
);
