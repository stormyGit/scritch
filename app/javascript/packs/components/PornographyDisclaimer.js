          ...
          <List>
            <ListItem>
              ...
              <ListItemText
                ...
                } is a pornographic website and is forbidden for minors. If you are a minor, please leave immediately.`}
              />
            </ListItem>
            <ListItem>
              <ListItemIcon>
              ...
              <ListItemText
                ...
                primary={`${
                  process.env.SITE_NAME
                } est un site pornographique interdit aux mineurs. Si vous êtes mineur veuillez quitter cette page immédiatement.`}
              />
            </ListItem>
            <ListItem>
              <ListItemIcon>
              ...
              <ListItemText
                ...
                primary={`${
                  process.env.SITE_NAME
                } es una web pornográfica y su visualización esta prohibida a menores de 18 años. Si eres menor, abandona la pagina inmediatamente.`}
              />
            </ListItem>
            <ListItem>
              <ListItemIcon>
              ...
              <ListItemText
                ...
                primary={`${
                  process.env.SITE_NAME
                } ist eine pornografische Internetseite und für Minderjährige verboten. Wenn du minderjährig bist, verlasse die Seite bitte unverzüglich.`}
              />
            </ListItem>
          </List>
        </DialogContent>
