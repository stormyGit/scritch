    ...
    <DialogContent>
      <List>
        ...
        <ListItem>
          ...
          <ListItemText inset primary="By uploading content on Murrtube, you grant us permission to use and alter this content for the sole purpose of providing our service (e.g. to crop and resize images and videos)." />
        </ListItem>
        <ListItem>
          <ListItemIcon>
            <CheckIcon />
