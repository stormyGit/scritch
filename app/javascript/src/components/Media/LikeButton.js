...
const NoFavoriteIcon = props => (
  <SvgIcon {...props}>
    ...
    <circle strokeWidth="2" stroke="#fe94d0" fill="none" cx="4.5" cy="9.5" r="2.5" />
    <circle strokeWidth="2" stroke="#fe94d0" fill="none" cx="9" cy="5.5" r="2.5" />
    <circle strokeWidth="2" stroke="#fe94d0" fill="none" cx="15" cy="5.5" r="2.5" />
    <circle strokeWidth="2" stroke="#fe94d0" fill="none" cx="19.5" cy="9.5" r="2.5" />
    <path
      strokeWidth="2"
      stroke="#fe94d0"
      fill="none"
