...
export const LOAD_MAKERS = gql`
    query Makers(
        ...
        makers(name: $name, country: $country, region: $region, limit: $limit, offset: $offset) {
            nodes {
                ...MakerFragment
            }
        }
...
export type MakersData = {
    makers: { nodes: MakerFragment[]; totalCount: number; endCursor: string }
}

export default (options?: QueryHookOptions<MakersData, MakersQueryVariables>) => {
